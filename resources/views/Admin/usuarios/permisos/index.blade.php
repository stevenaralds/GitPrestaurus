          ...
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('permissions.create') }}" class="pull-right btn btn-sm btn-info glyphicon glyphicon-plus-sign">
                                Crear
                            </a>
                        </div>
                    </div>
              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  @foreach($permissions as $permission)
                    ...
                    <tr>
                        <td width="10px">{{ $permission->id }}</td>
                      ...
                      <td width="10px">
                          <a href="{{ route('permissions.show', $permission->id) }}" title="Ver" class="btn btn-primary glyphicon glyphicon-search"></a>

                      </td>
                      <td width="10px">
                          <a href="{{ route('permissions.edit', $permission->id) }}" title="Editar" class="btn btn-warning glyphicon glyphicon-edit"></a>
                      </td>


                      <td width="10px">
                        {!! Form::open(['route' => ['permissions.destroy', $permission->id], 'method' => 'DELETE', 'id' => 'form-borrar']) !!}
